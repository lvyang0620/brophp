...
<{section loop=$data name="ls"}>
	<tr>
		...
		<td align="center">
			<{if $data[ls].accounting eq 1 }>
				<input type="checkbox" name="accounting[]" checked="<{$data[ls].accounting}>" disabled="disabled">
			<{else}>
				<input type="checkbox" name="accounting[]" disabled="disabled">
			<{/if}>

<?php
	...
	define("PASS", "lvyang@123456");                                   //数据库密码
	...
	//$memServers = array("192.168.1.27", 11211);	     //使用memcache服务器
	//$memServers = array("192.168.1.42", 11211);	     //使用memcache服务器
	//$memServers = array("192.168.31.132", 11211);	     //使用memcache服务器
	/*
